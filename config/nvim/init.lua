...
require("gruvbox").setup({
  contrast = "hard",
  transparent_mode = true, -- Matches your 'transparent_background': 1
})
...
-- COMPLETION SETUP (CMP) - Implementing your requested logic
...
cmp.setup({
  ...
  -- NO PRESELECTION (Don't select first item automatically)
